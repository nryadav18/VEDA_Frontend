...
import img from '../assets/My_Images/veda_logo.png';
...
function My_Footer(props) {
    ...
    return (
        <footer className="footer">
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="footer__bottom">
                                <Link to="/" className="logo"><img src={img} alt="veda'24" width={300} height={200}/></Link>
                                <div className="center mb--30">
                                    <ul className="list">
                                        <li><Link to="/">Home</Link></li>
                                        <li><Link to="/nfts">Events</Link></li>
                                        <li><Link to="/about">About Us</Link></li>
                                        <li><Link to="/team">Team</Link></li>
                                        <li><Link to="/contact">Contact</Link></li>
                                    </ul>
                                    <p>Copyright © 2024, VEDA'24. Designed by Technical Hub.</p>
                                </div>
                ...
                {
                isVisible && 
                <Link to='#' onClick={scrollToTop}   id="scroll-top"><HiChevronDown /></Link>
            }
            </footer>
    );
}
