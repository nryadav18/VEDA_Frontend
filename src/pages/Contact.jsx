                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="block-text center">
                                ...
                                <h3 className="heading">Reach Out to Us  <br />
                                Anytime
                                    </h3>
                            </div>
                                ...
                                <div className="info">
                                    ...
                                    <ul className="list">
                                        <li>
                                            ...
                                            <p> Aditya Nagar, ADB Road,Surampalem - Pin:533437</p>                                        
                                        </li>
                                        <li>
                ...
                <div className="container">
                    <div className="row">
                        <div className="map__main">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15254.62901912707!2d82.0667995!3d17.0894099!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a378165aaaaaaab%3A0x481e8b12b4b80715!2sAditya%20Engineering%20College!5e0!3m2!1sen!2sin!4v1723882086029!5m2!1sen!2sin" title='map' height="500" allowFullScreen="" aria-hidden="false" tabIndex="0" />
                        </div>
                    </div>
                </div>
            </div>
