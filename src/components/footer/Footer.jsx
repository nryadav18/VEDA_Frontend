...
function Footer(props) {
    ...
    return (
        <footer className="footer">
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            ...
                            <div className="footer__bottom">
                                <Link to="/veda2024" className="logo" style={{fontSize:"19px"}}>Veda'2k24</Link>

                                <div className="center mb--30">
                                    <ul className="list">
                                        <li><Link to="/veda2024">Home</Link></li>
                                        <li><Link to="/veda2024/Events">Events</Link></li>
                                        {/* <li><Link to="/veda2024/team">Team</Link></li> */}
                                        <li><Link to="/veda2024/contact">Contact</Link></li>
                                        <li><Link to="/veda2024/about">About</Link></li>
                                        {/* <li><Link to="/contact">Metrics</Link></li>      */}
                                    </ul>
                                    <p style={{color:"white" , fontSize:"12px"}}>Copyrights © 2024, VEDA. Designed by Technical Hub</p>
                                </div>
                                <ul className="list-social">
                                    <li>
                                        <a href='https://www.facebook.com/AECaditya'><svg width="20" height="18" viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li>
                                        <a href='https://x.com/AdityaEnggClg'>
                                        <svg width="20" height="18" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li>
                                    <a href='https://www.instagram.com/aditya_engg_colleges/'>
                                    ...
                                    <li>
                                    <a href='https://www.youtube.com/channel/UCQmzQy9b4i6Q6X86DkX1H1g' >
                ...
                {
                isVisible && 
                <Link to='#' onClick={scrollToTop}   id="scroll-top"><HiChevronUp fontSize={30}/></Link>
            }
            </footer>
    );
}
